...
Index.html:
    Who we help - perhaps lessen the gutters on mobile
    Add a lot more space in between each section, make them feel as though they are their own
    Services overview: 
        Change it so that mobile reveals *only* the small text when clicked (remove title transparency) - Done
        Mess around with color scheme and darkening when we have final images
    ...
    Reword how it works
        *Temporarily good enough?*
        ...
        Ideas
            Add a large image for background
            Change it into a "Free Diagnostic Exam" section - make everything about that (this feels best to me)
    Locations
        Update to proper addresses
        Make the images look kinda decent at minimum

Services

    Update the test bar for mobile users
...
Results
    ...
    Build the banner ad that was sent
        Slider psuedo animations have been built
            Used js and rebuilt my css to get this working
        Add in images, with 2 in the middle row (SAT scores and college acceptance) (perhaps desktop view only)

Organize /images/

Add links from everywhere to everywhere, make it easy to find what you are looking for
